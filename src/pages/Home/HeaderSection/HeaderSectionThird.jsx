...
const HeaderSectionThird = () => {
  ...
  return (
    <div className="flex justify-evenly pt-[5.5rem] bg-gradient-to-b from-bg-dark-blue via-bg-middle-blue to-bg-light-pink h-screen overflow-hidden">
      
        <div className="flex flex-col w-[23.4375rem] pt-[15rem] container-text-fadeOut">

          <section className='text-fadeOut  min-h-[51rem]' id="introFirst3">
            <h2 className="text-5xl text-white " >
              Rejoignez<br/> la plateforme ouverte<br/> de l’action climatique</h2>
          </section>

          <section className='text-fadeOut  min-h-[51rem] opacity-0'id="introSecond3">
          ...
          <section className="text-fadeOut  min-h-[31rem] text-5xl text-white opacity-1" id="introThird3">
